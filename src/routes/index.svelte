...
<PageTransitionWrapper>
	<div class="container flex flex-col mx-auto px-4 pt-10 md:pt-16">
		<h3 class="text-lg sm:text-2xl pb-2 uppercase font-bold">
			<small>Hi there,</small>
			<span class="text-corporateDark-primary">I'm José</span>
		</h3>

		<h1 class="text-4xl sm:text-6xl pb-4 font-serif font-black">
			Striving for
			<span class="text-corporateDark-primary"> awesome web apps </span>!
		</h1>

		<p class="py-4 text-xl">
			I am a Software Developer with focus in Web and Cross Platform apps. Plus
			a sprincle of design, drawing and painting.
		</p>
		...
		>
			<a
				...
				><svg
					class="h-7 fill-current text-gray-600 hover:text-green-700"
					role="img"
					viewBox="0 0 24 24"
